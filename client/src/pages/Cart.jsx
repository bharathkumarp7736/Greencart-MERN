        ...
        try {
            ...
            if (data.success) {
                ...
                if (data.addresses.length > 0) {
                    setSelecttedAddress(data.addresses[0])
                }
            } else {
                    ...
                    <div className="relative flex justify-between items-start mt-2">
                        ...
                        {showAddress && (
                            <div className="absolute top-12 py-1 bg-white border border-gray-300 text-sm w-full">
                                {addresses.map((address,index)=>(<p onClick={() => {setSelecttedAddress(address); setShowAddress(false)}} key={index} className="text-gray-500 p-2 hover:bg-gray-100">
                                    {address.street},
                                    {address.city},
                                    {address.state},
                                    {address.country}
