  ...
  return (
    product && (
      <div
        ...
        className="border border-gray-500/20 rounded-md md:px-4 px-3 py-3 bg-white w-full cursor-pointer"
      >

        <div className="group flex items-center justify-center px-2">
          <img
            className="group-hover:scale-105 transition duration-300 max-w-26 md:max-w-36"
